...
export const ResumeLayout: MDXComponents = {
    ...
    p: (props): JSX.Element => (
        <p
            className="desktop:body1 body2 text-neutral-black-default flex dark:text-neutral-white-darker mobile:text-neutral-black-dark mobile:dark:text-neutral-black-dark mt-4"
            {...props}
        />
    ),
